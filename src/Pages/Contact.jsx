    ...
    return (
        <>
            ...
            <form className='flex flex-col  mx-auto mt-8 mb-8 w-[600px] h-[500px] bg-[#A27B5C] rounded-lg pb-2' ref={form} onSubmit={sendEmail}>
                ...
                <input type="submit" className='submit flex justify-center items-center w-[580px] h-[69px] text-white bg-black rounded-full text-[19px] font-bold cursor-pointer' value="Send" />
                </div>
