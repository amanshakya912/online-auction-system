                    ...
                    >
                        <ul className="flex flex-col md:flex-row items-center md:gap-x-8 gap-y-5 p-4 md:p-0">
                            <Link to={'/'}>
                                <li
                                    className={`${
                                        pathname === '/' ? 'text-[#6c3c3c] font-bold' : 'hover:text-[#6c3c3c]'
                                    }`}
                                >
                                    Home
                                </li>
                            ...
                            <Link to={'/browse-auction'}>
                                <li
                                    className={`${
                                        pathname === '/browse-auction' ? 'text-[#6c3c3c] font-bold' : 'hover:text-[#6c3c3c]'
                                    }`}
                                >
                                    Browse Auctions
                                </li>
                            ...
                            <Link to={'/create-auction'}>
                                <li
                                    className={`${
                                        pathname === '/create-auction' ? 'text-[#6c3c3c] font-bold' : 'hover:text-[#6c3c3c]'
                                    }`}
                                >
                                    Create Auction
                                </li>
                            ...
                            <li
                                className={`${
                                    pathname === '/category' ? 'text-[#6c3c3c] font-bold' : 'hover:text-[#6c3c3c]'
                                }`}
                            >
                                Category
                            </li>
                            <Link to={'/contact'}>
                                <li
                                    className={`${
                                        pathname === '/contact' ? 'text-[#6c3c3c] font-bold' : 'hover:text-[#6c3c3c]'
                                    }`}
                                >
                                    Contact
                                </li>
                            ...
                            <Link to={'/sign-up'}>
                                ...
                                {/* Dropdown menu */}
                                {isDropdownOpen && (
                                    <div className="absolute bg-[#242628] text-white p-2 rounded-md right-0 mt-2 px-4">
                                        <button
                                            onClick={logout} 
                                            className="py-2 px-5 text-sm w-full text-left hover:bg-gray-600 cursor-pointer"
                                        >
                                            Logout
                                        </button>
                                    </div>
